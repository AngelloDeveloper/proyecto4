<?php 
    ...
    if(!empty($_POST['reg_user'])) {
        $insert = $objUser->insertUser($_POST['email'], $_POST['password']);
        echo $insert;
    }
                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small row">
                                            <a class="col-md-6" href="login.php">¿Tienes cuenta? Ir a Inicio de Sesión</a>
                                            <a class="col-md-6" href="index.php">Ir a inicio</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
